...
使い慣れたマークダウン形式で、**表現力豊かな**ノートを作成できます。

タイトル下のメニューはそれぞれ、ブックマーク、編集、PDF ダウンロードとなっております。

---

#### 上部メニューの「新規ノート」から、新しいノートを作成してみましょう。

* 「プライベートにする」にチェックを入れると、他のユーザーからの検索にかからなくなり、内容が見られなくなります。

#### 気になるジャンルの投稿をする人をフォローしよう

* フォローしている人がノートを作成すると、通知が届きます。見逃す心配はいりません！
...
n = create_rich_note(u1, "検索もできます", <<~'EOS'
<strong>リッチテキスト</strong>モードを使うと<em>表現力豊かな</em>テキストを分かりやすく作成できます。
<br><br><blockquote>便利〜！</blockquote>
<br>ところで、Nottable には検索機能もあります。
<br>上部メニューの検索ボックスで「風呂」で検索してみて下さい。
<br>興味のある投稿をしている人が見つかりましたでしょうか？
EOS
)
...
朝すっきり目覚められると、気持ちいいですね。

他にも見つけ次第追記していくので、ぜひブックマークしてください！
EOS
)
